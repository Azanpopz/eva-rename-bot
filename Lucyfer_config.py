...
START_MSG = environ.get("START_MSG", my.DEFAULT_MSG)
...
SET_SPEL_M = environ.get("SPELL_MODE_TEXT", my.SPELL_CHECK)
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", None))
DATABASE_URI = environ.get("DATABASE_URI", None)
FORCE = environ.get('FORCES_SUB')
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", my.FILE_CAPTIONS)
